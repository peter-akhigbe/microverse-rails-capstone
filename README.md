...
```sh
  cd Blog app
  git clone https://github.com/peter-akhigbe/microverse-rails-capstone.git
```
...
Feel free to check the [issues page](https://github.com/peter-akhigbe/microverse-rails-capstone/issues).
